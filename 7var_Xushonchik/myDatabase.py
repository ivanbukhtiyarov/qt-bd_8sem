...
def initDatabase1():
    ...
    tmp_cash = Cashier.create(store = tmp_store, name = "Ivanov", salary = 1)
...
def initDatabase2():
    ...
    tmp_cash = Cashier.create(store = tmp_store, name = "Ivanova", salary = 1000000)
...
class MyDataBase:
    ...
    def second(self, substr):
        ...
        return MyModel(tmp, ['адреса складов', 'организация', 'продукт', 'цена'])
    ...
    def third(self, num, date):
        ...
        return MyModel(tmp, ['рейтинг', 'автор', 'товар', 'адрес'])
